...
if st.button("Predict UCS"):
    ...
    if EC >= 0:
        ...
        input_data = pd.DataFrame(
            [[FA,SCBA,EC,Gs,PI,FSI,MDUW,OMC,UPV,CuringDays]],
        ...
        st.success(f"Best Performing Model: {best_model['Model']} ({best_model['Accuracy (%)']}%) | Predicted UCS = {best_model['Predicted UCS (kPa)']} kPa")
        ...
        ax.set_title("Predicted UCS Comparison")
